...
echo "Размер файла не должен превышать 512Кб";
					...
					$insert_sql = "INSERT INTO car_model (marka_id, mark_name, model_name, cuzovtype, kolmest, koldver, dlina, wirina, visota, typedvig, obdvig, moshnost, krutmoment, dvigsite, typetop, rashod, klapan, privod, maxspeed, razgon, photo, history) VALUES ('{$mark}' , '{$mark_name}', '{$model}' , '{$cuzovtype}', '{$kolmest}', '{$koldver}', '{$dlina}', '{$wirina}', '{$visota}', '{$typedvig}', '{$obdvig}', '{$moshnost}', '{$krutmoment}', '{$dvigsite}', '{$typetop}', '{$rashod}', '{$klapan}', '{$privod}', '{$maxspeed}', '{$razgon}', '{$apend}', '{$history}')";
	...
	<div class="add">
			...
			<div class="udob">
				<form method="post" action="add-auto.php" enctype=multipart/form-data>
					...
					Фото: <input type="file" name="userfile" /><br /><br>
					История: <textarea name="history" cols="40" rows="10"></textarea><br />
					<br>
